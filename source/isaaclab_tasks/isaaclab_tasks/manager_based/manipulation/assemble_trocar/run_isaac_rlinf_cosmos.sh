...
git checkout pengfeig/timeline_benchmark
...
export ISAAC_PATH=/localhome/local-mingxueg/pengfeig/isaac-sim-standalone-6.0.0-rc.22
...
bash start_cosmos_workers.sh --num-gpus 8 --wait-ready
