...
RAY_ADDRESS=local RAY_TMPDIR=/tmp/play_default3 \
python scripts/reinforcement_learning/rlinf/play.py \
  --config_path /localhome/local-pengfeig/pengfeig/IsaacLab/source/isaaclab_tasks/isaaclab_tasks/manager_based/manipulation/assemble_trocar/config \
  --config_name isaaclab_ppo_gr00t_assemble_trocar_eval \
  --num_envs 128 \
  --video \
  2>&1 | tee play_128env_450steps_global_step_336_nodeformable_default3.log

# RAY_ADDRESS=local RAY_TMPDIR=/tmp/play_default4 \
# python scripts/reinforcement_learning/rlinf/play.py \
#   --config_path /localhome/local-pengfeig/pengfeig/IsaacLab/source/isaaclab_tasks/isaaclab_tasks/manager_based/manipulation/assemble_trocar/config \
#   --config_name isaaclab_ppo_gr00t_assemble_trocar_eval \
#   --num_envs 128 \
#   --video \
#   2>&1 | tee play_128env_450steps_global_step_328_nodeformable_default9.log
...
#   --num_envs 128 \
#   --video \
#   2>&1 | tee play_128env_450steps_global_step_328_nodeformable_default10.log
...
#   --num_envs 128 \
#   --video \
#   2>&1 | tee play_128env_450steps_global_step_328_nodeformable_default1_ac8.log
...
RAY_ADDRESS=local RAY_TMPDIR=/tmp/play_orca3 \
ASSEMBLE_TROCAR_SCENE_VARIANT=orca \
python scripts/reinforcement_learning/rlinf/play.py \
  --config_path /localhome/local-pengfeig/pengfeig/IsaacLab/source/isaaclab_tasks/isaaclab_tasks/manager_based/manipulation/assemble_trocar/config \
  --config_name isaaclab_ppo_gr00t_assemble_trocar_eval \
  --num_envs 128 \
  --video \
  2>&1 | tee play_128env_450steps_global_step_336_nodeformable_orca3.log
...
#   --num_envs 128 \
#   --video \
#   2>&1 | tee play_128env_450steps_global_step_328_nodeformable_orca1_ac8.log
...
RAY_ADDRESS=local RAY_TMPDIR=/tmp/play_factory3 \
ASSEMBLE_TROCAR_SCENE_VARIANT=factory \
python scripts/reinforcement_learning/rlinf/play.py \
  --config_path /localhome/local-pengfeig/pengfeig/IsaacLab/source/isaaclab_tasks/isaaclab_tasks/manager_based/manipulation/assemble_trocar/config \
  --config_name isaaclab_ppo_gr00t_assemble_trocar_eval \
  --num_envs 128 \
  --video \
  2>&1 | tee play_128env_450steps_global_step_336_nodeformable_factory3.log
...
#   --num_envs 128 \
#   --video \
#   2>&1 | tee play_128env_450steps_global_step_328_nodeformable_factory1_ac8.log
...
RAY_ADDRESS=local RAY_TMPDIR=/tmp/play_surgical3 \
ASSEMBLE_TROCAR_SCENE_VARIANT=surgical \
python scripts/reinforcement_learning/rlinf/play.py \
  --config_path /localhome/local-pengfeig/pengfeig/IsaacLab/source/isaaclab_tasks/isaaclab_tasks/manager_based/manipulation/assemble_trocar/config \
  --config_name isaaclab_ppo_gr00t_assemble_trocar_eval \
  --num_envs 128 \
  --video \
  2>&1 | tee play_128env_450steps_global_step_336_nodeformable_surgical3.log
...
#   --num_envs 128 \
#   --video \
#   2>&1 | tee play_128env_450steps_global_step_328_nodeformable_surgical1_ac8.log
